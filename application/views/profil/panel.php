              ...
              <!-- Illustrations -->
                <div class="card shadow mb-4">
                  <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Pengaturan Halaman Profil</h6>
                  </div>
                  <div class="card-body">
                    ...
                    <form class="user" method="post" action="<?= base_url("about/edit");?>" enctype="multipart/form-data">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="id" value="<?= $profil->id_about;?>">
                        <input type="text" class="form-control"  name="judul" value="<?= $profil->judul; ?>">
                      </div>
                      <div class="form-group">
                        <label>Isi</label>
                        <textarea class="form-control" id="des" name="isi"><?= $profil->isi; ?></textarea>
                      </div>
