                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                <div class="text-center">
                                    ...
                                    <br>
                                    <p>Silahkan masukkan data diri Anda untuk mendaftar!</p>
                                </div>
                                ...
                                <form class="user" method="post" action="<?=base_url('UserAuth/register'); ?>">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <span class="input-group-text">
                                                    <i id="togglePasswordConfirm" class="fas fa-eye-slash" onclick="togglePasswordConfirm()"></i>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <hr>
                                <div class="text-left">
                                    <p class="small">Sudah mempunyai akun? <a href="<?=base_url('UserAuth');?>">Login</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
